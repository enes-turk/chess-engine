...
class Move():
    ...
    def __str__(self):
        ...
        # two of the same type piece moving to a square, Nbd2 if both knights can move to d2
        
        # also adding + for check move and # for chechmate move
